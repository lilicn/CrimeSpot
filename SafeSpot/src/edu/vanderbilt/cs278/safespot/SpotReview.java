	...
	private class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case Util.RESPONSE: {
				...
				//Toast.makeText(mContext, "Server: "+ responseTxt, Toast.LENGTH_SHORT).show();
				break;
			}
			default:
...
/*		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
		...
		listAdapter = new ArrayAdapterItem(this, R.layout.list_item, locationsreivews);
	...
	public void onSubmitClick(View v){
		Toast.makeText(this, "Sending Review to Server", Toast.LENGTH_SHORT).show();
		
		Double rating = (double) ((ratingBar_facility.getRating()+
		ratingBar_light.getRating()+
		ratingBar_people.getRating())/3);
		
		Log.d(TAG, "start service");
		Intent intent = new Intent(this, SpotService.class);
		intent.putExtra(Util.REQUEST_TYPE, Util.Request_Type.SEND_REVIEW.ordinal());
